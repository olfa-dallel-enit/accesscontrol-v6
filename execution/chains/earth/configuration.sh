...
#crossdomaind tx crossdomain create-cooperation-network-features [depth] [cost] [interest-list] [location-list] [last-update] [flags]
crossdomaind tx crossdomain create-cooperation-network-features 0  300 "" "" "" --from alice --yes --home ~/.earth --chain-id earth --node tcp://localhost:26657 --gas=auto --gas-adjustment=1.15
