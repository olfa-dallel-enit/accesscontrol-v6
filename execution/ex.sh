...
#earth-neptune
#crossdomaind tx cdac send-establish-cooperation  cdac channel-2 "2023-02-03 00:00:00" "2025-02-03 00:00:00" "finance" 150 --from alice --yes --home ~/.earth --chain-id earth --node tcp://localhost:26657 --gas=auto --gas-adjustment=1.15
#earth-jupiter
#crossdomaind tx cdac send-establish-cooperation  cdac channel-3  "2023-02-03 00:00:00" "2025-02-03 00:00:00" "finance" 200 --from alice --yes --home ~/.earth --chain-id earth --node tcp://localhost:26657 --gas=auto --gas-adjustment=1.15
