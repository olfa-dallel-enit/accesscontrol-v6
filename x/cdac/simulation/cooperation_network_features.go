...
func SimulateMsgUpdateCooperationNetworkFeatures(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		var (
			...
			allCooperationNetworkFeatures = k.GetAllCooperationNetworkFeatures(ctx)
			found                         = false
		)
		for _, obj := range allCooperationNetworkFeatures {
			simAccount, found = FindAccount(accs, obj.Creator)
			if found {
				cooperationNetworkFeatures = obj
				break
			}
		}
		if !found {
		...
		msg.Id = cooperationNetworkFeatures.Id
