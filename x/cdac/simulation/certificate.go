...
func SimulateMsgUpdateCertificate(
	ak types.AccountKeeper,
	bk types.BankKeeper,
	k keeper.Keeper,
) simtypes.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		if !found {
			return simtypes.NoOpMsg(types.ModuleName, msg.Type(), "certificate creator not found"), nil, nil
		}
		msg.Creator = simAccount.Address.String()
		msg.Id = certificate.Id
...
func SimulateMsgDeleteCertificate(
	ak types.AccountKeeper,
	bk types.BankKeeper,
	k keeper.Keeper,
) simtypes.Operation {
