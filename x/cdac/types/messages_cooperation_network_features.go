...
func NewMsgUpdateCooperationNetworkFeatures(creator string, id uint64, depth uint64, cost uint64, interestList []string, locationList []string, lastUpdate string) *MsgUpdateCooperationNetworkFeatures {
...
func NewMsgDeleteCooperationNetworkFeatures(creator string, id uint64) *MsgDeleteCooperationNetworkFeatures {
