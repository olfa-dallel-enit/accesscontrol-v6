...
func (m *IbcConnection) GetPort() string {
	if m != nil {
		return m.Port
	}
	return ""
...
var fileDescriptor_0013f5bdae3ab933 = []byte{
	...
	0xcc, 0xcc, 0xd3, 0x03, 0x29, 0x53, 0x4a, 0xe7, 0xe2, 0xf5, 0x4c, 0x4a, 0x76, 0x86, 0x2b, 0x14,
	...
	0x0c, 0x82, 0x71, 0x85, 0x84, 0xb8, 0x58, 0x0a, 0xf2, 0x8b, 0x4a, 0x24, 0x98, 0xc1, 0xc2, 0x60,
	0x36, 0x58, 0x75, 0x51, 0x6a, 0x62, 0x49, 0x7e, 0x91, 0x04, 0x0b, 0x54, 0x35, 0x84, 0xeb, 0x64,
	0x74, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c,
	0xc7, 0x70, 0xe1, 0xb1, 0x1c, 0xc3, 0x8d, 0xc7, 0x72, 0x0c, 0x51, 0x12, 0x48, 0x8e, 0xd2, 0xaf,
	0xd0, 0x07, 0xbb, 0xbe, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec, 0x6a, 0x63, 0x40, 0x00,
	0x00, 0x00, 0xff, 0xff, 0x9e, 0xee, 0x9a, 0x47, 0xd2, 0x00, 0x00, 0x00,
}
...
func (m *IbcConnection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Port) > 0 {
		i -= len(m.Port)
		copy(dAtA[i:], m.Port)
		i = encodeVarintIbcConnection(dAtA, i, uint64(len(m.Port)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Channel) > 0 {
