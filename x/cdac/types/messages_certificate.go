...
func NewMsgCreateCertificate(creator string, publicKey *PublicKey, validity *Validity) *MsgCreateCertificate {
...
func NewMsgUpdateCertificate(creator string, id uint64, publicKey *PublicKey, validity *Validity) *MsgUpdateCertificate {
