...
func NewMsgUpdateForwardPolicy(creator string, id uint64, mode string, domainList []string, locationList []string) *MsgUpdateForwardPolicy {
...
func NewMsgDeleteForwardPolicy(creator string, id uint64) *MsgDeleteForwardPolicy {
